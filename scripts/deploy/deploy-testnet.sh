...
CAMPAIGN_WASM_HASH=$(stellar contract install --wasm target/wasm32v1-none/release/preorder_campaign.wasm --source "$SOURCE" --network "$NETWORK")
...
PREORDER_CAMPAIGN_WASM_HASH=$CAMPAIGN_WASM_HASH
